...
<div id="form_container">
    ...
    <form id="form_996464" class="appnitro"  method="post" action="index.php" autocomplete="off">
        <div class="form_description">
            <h2>Consulta Tipo Impresoras</h2>
	</div>						
	<ul >
            <li id="li_2" >
		<label class="description" for="element_2">Tipo Impresora </label>
                <div>
                    <input id="descripcion" name="descripcion" class="element text medium" type="text" maxlength="10" value="" required/> 
                </div>
            </li>
            <li class="buttons">
                <input type="hidden" name="control" id="control" value="ResultadoBusquedaTipoImpresora">
